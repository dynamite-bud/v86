...
IMAGES=../../../images
PREFIX=alpine-virtio-gpu-alacritty-codex
...
CONTAINER_NAME=v86-virtio-gpu-alpine-alacritty-codex
IMAGE_NAME=v86-virtio-gpu-alpine-alacritty-codex
...
python3 ../virtio-gpu-alpine/image_contract.py \
    ...
    --probe-success-marker "V86_ALACRITTY_CODEX_READY=PASS" \
    --output "$OUT_CONTRACT"
