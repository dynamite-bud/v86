...
PREFIX=virtio-gpu-multi-core-alpine-codex
...
CONTAINER_NAME=v86-virtio-gpu-multi-core-alpine-codex
IMAGE_NAME=v86-virtio-gpu-multi-core-alpine-codex
BASE_APPLIANCE_IMAGE=v86-virtio-gpu-alpine-codex:multi-core-base
